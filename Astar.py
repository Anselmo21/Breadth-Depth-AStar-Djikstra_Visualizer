...
class AStar():
    ...
    def draw_all_paths(self, current):
        ...
        pygame.draw.rect(self.app.DISP, TOMATO, (240 + self.start_node_x * 24, self.start_node_y * 24, 24, 24), 0)
        ...
        for x in range(52):
            pygame.draw.line(self.app.DISP, ALICE, (GStart_x + x * 24, GStart_y), (GStart_x + x * 24, GEND_y))
        for y in range(30):
            pygame.draw.line(self.app.DISP, ALICE, (GStart_x, GStart_y + y * 24), (GEnd_x, GStart_y + y * 24))
